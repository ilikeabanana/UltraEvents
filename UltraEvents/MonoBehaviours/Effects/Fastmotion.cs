...
namespace UltraEvents.MonoBehaviours.Effects
{
    ...
    public class Fastmotion : Effect
    {
        ...
        private void Awake()
        {
            Time.timeScale = UltraEventsPlugin.Instance.TimeScaleFastMotion.Value;
            MonoSingleton<TimeController>.Instance.timeScaleModifier = UltraEventsPlugin.Instance.TimeScaleFastMotion.Value;
        }
